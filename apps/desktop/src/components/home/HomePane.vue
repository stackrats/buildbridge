...
// Without remote builds the overview has one shared resource rather than two, so the wells
// stop being a pair and the signing one takes the full width.
...
<template>
    <div class="mx-auto max-w-4xl space-y-4 p-5">
        ...
        <section class="grid gap-3" :class="remoteBuilds ? 'md:grid-cols-2' : ''">
