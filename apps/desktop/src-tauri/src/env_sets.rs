...
#[tauri::command]
pub(crate) async fn list_env_sets(app: AppHandle) -> Result<Vec<EnvSetSummary>, String> {
...
#[tauri::command]
pub(crate) async fn save_env_set(
    app: AppHandle,
    input: EnvSetInput,
...
#[tauri::command]
pub(crate) async fn delete_env_set(
    app: AppHandle,
    set_id: String,
    input: ConfirmInput,
) -> Result<Vec<EnvSetSummary>, String> {
...
#[tauri::command]
pub(crate) async fn attach_env_set(
    app: AppHandle,
    machine_id: String,
...
/// inside a summary.
#[tauri::command]
pub(crate) async fn reveal_env_secrets(set_id: String) -> Result<Vec<EnvVariableSummary>, String> {
    let stored = read_env_sets().await?;
