...
#[tauri::command]
pub(crate) async fn save_signing_kit(
    app: AppHandle,
...
#[tauri::command]
pub(crate) async fn list_signing_kits(app: AppHandle) -> Result<Vec<SigningKitSummary>, String> {
...
#[tauri::command]
pub(crate) async fn delete_signing_kit(
    app: AppHandle,
    kit_id: String,
    input: ConfirmInput,
) -> Result<Vec<SigningKitSummary>, String> {
...
#[tauri::command]
pub(crate) async fn attach_signing_kit(
    app: AppHandle,
    machine_id: String,
...
pub(crate) fn attached_kit_id(app: &AppHandle, machine_id: &str) -> Result<Option<String>, String> {
