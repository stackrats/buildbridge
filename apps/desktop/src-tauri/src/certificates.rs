...
#[tauri::command]
pub(crate) async fn create_apple_distribution_certificate(
    app: AppHandle,
    kit_id: String,
...
#[tauri::command]
pub(crate) async fn create_apple_development_certificate(
    app: AppHandle,
    kit_id: String,
    input: CreateAppleCertificateInput,
) -> Result<CreateAppleCertificateResult, String> {
...
pub(crate) fn managed_apple_certificates_dir(app: &AppHandle) -> Result<PathBuf, String> {
    app.path()
        .app_config_dir()
...
pub(crate) struct CertificateRequestFiles {
    pub(crate) csr_pem: String,
}

pub(crate) struct PackagedCertificate {
