...
#[tauri::command]
pub(crate) async fn install_usb_release_rule(
    app: AppHandle,
...
#[tauri::command]
pub(crate) async fn remove_usb_release_rule(
    app: AppHandle,
) -> Result<buildbridge_docker_osx::HostUsbStatus, String> {
    let guard = begin_host_usb_operation(&app)?;
...
#[tauri::command]
pub(crate) async fn migrate_machine_for_usb(
    app: AppHandle,
    machine_id: String,
    input: ConfirmInput,
...
#[tauri::command]
pub(crate) async fn rebuild_machine_container(
    app: AppHandle,
    machine_id: String,
    input: ConfirmInput,
) -> Result<MacBuilderView, String> {
...
#[tauri::command]
pub(crate) async fn attach_usb_device(
    app: AppHandle,
    machine_id: String,
...
#[tauri::command]
pub(crate) async fn detach_usb_device(
    app: AppHandle,
    machine_id: String,
) -> Result<MacBuilderView, String> {
    let paths = MachinePaths::resolve(&app, &machine_id)?;
...
pub(crate) fn clear_usb_attach_issue(app: &AppHandle, machine_id: &str) {
    if let Ok(mut issues) = app.state::<AppState>().usb_attach_issues.lock() {
