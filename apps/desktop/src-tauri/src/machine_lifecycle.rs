...
#[tauri::command]
pub(crate) async fn list_machines(app: AppHandle) -> Result<MachineListView, String> {
...
#[tauri::command]
pub(crate) async fn discard_machine_container(
    app: AppHandle,
    machine_id: String,
    input: ConfirmInput,
...
#[tauri::command]
pub(crate) async fn get_mac_builder_status(
    app: AppHandle,
    machine_id: String,
) -> Result<MacBuilderView, String> {
    let paths = MachinePaths::resolve(&app, &machine_id)?;
...
#[tauri::command]
pub(crate) async fn configure_mac_builder(
    app: AppHandle,
    machine_id: String,
    profile: MacBuilderConfig,
) -> Result<MacBuilderView, String> {
...
#[tauri::command]
pub(crate) async fn launch_mac_builder(
    app: AppHandle,
    machine_id: String,
) -> Result<MacBuilderView, String> {
    let paths = MachinePaths::resolve(&app, &machine_id)?;
...
#[tauri::command]
pub(crate) async fn stop_mac_builder(
    app: AppHandle,
    machine_id: String,
) -> Result<MacBuilderView, String> {
    let paths = MachinePaths::resolve(&app, &machine_id)?;
