...
#[tauri::command]
pub(crate) async fn verify_apple_developer_team(
    app: AppHandle,
    machine_id: String,
...
#[tauri::command]
pub(crate) async fn create_apple_replacement_profile(
    app: AppHandle,
    machine_id: String,
...
#[tauri::command]
pub(crate) async fn download_apple_profile(
    app: AppHandle,
    machine_id: String,
    profile_id: String,
...
#[tauri::command]
pub(crate) fn list_managed_apple_profiles(
    app: AppHandle,
