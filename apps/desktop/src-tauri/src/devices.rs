...
#[tauri::command]
pub(crate) async fn pair_guest_device(
    app: AppHandle,
    machine_id: String,
...
#[tauri::command]
pub(crate) async fn open_safari_web_inspector(
    app: AppHandle,
    machine_id: String,
...
#[tauri::command]
pub(crate) async fn list_guest_devices(
    app: AppHandle,
    machine_id: String,
) -> Result<MacBuilderView, String> {
    let guest = guest_context(&app, &machine_id).await?;
...
#[tauri::command]
pub(crate) fn open_developer_tools(window: tauri::WebviewWindow) -> Result<(), String> {
...
#[tauri::command]
pub(crate) async fn prepare_apple_device_signing(
    app: AppHandle,
    machine_id: String,
...
#[tauri::command]
pub(crate) async fn run_apple_device_build(
    app: AppHandle,
    machine_id: String,
...
#[tauri::command]
pub(crate) async fn clear_apple_device_run(
    app: AppHandle,
    machine_id: String,
) -> Result<MacBuilderView, String> {
    let paths = MachinePaths::resolve(&app, &machine_id)?;
...
#[tauri::command]
pub(crate) async fn adopt_guest_podfile_lock(
    app: AppHandle,
    machine_id: String,
