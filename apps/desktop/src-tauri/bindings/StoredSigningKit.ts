...
export type StoredSigningKit = {
    ...
    provisioningProfilePaths: Array<string>;
    guestKeychainPassword: string | null;
    createdAtEpochSeconds: number;
    /**
     * The optional development identity, for Debug builds on registered phones.
     */
    developmentCertificatePath: string | null;
    developmentCertificatePassword: string | null;
    /**
