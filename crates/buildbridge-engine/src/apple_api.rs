...
#[derive(Debug)]
pub struct RegisteredAppleDevice {
...
#[derive(Debug)]
pub struct DevelopmentProfileSearch {
...
#[derive(Debug, Deserialize, TS)]
#[ts(export)]
pub struct ProfileMembershipsResponse {
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct AppleTeamVerificationResult {
    key_id: String,
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct AppleProvisioningProfileSummary {
    pub(crate) id: String,
    pub(crate) name: String,
    pub(crate) platform: String,
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct AppleCertificateSummary {
    pub(crate) id: String,
    pub(crate) name: String,
...
#[derive(Debug)]
pub struct CreatedAppleCertificate {
    pub(crate) certificate: AppleCertificateSummary,
    pub(crate) content: Vec<u8>,
}

pub struct CreatedAppleProfile {
...
#[derive(Debug, Deserialize, TS)]
#[ts(export)]
pub struct BundleIdCapabilityResource {
