...
pub const MACHINE_CHANGED_EVENT: &str = "machine-changed";
...
pub struct MachineProgressEvent<T: Serialize> {
    machine_id: String,
    #[serde(flatten)]
    progress: T,
}
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct MachineChangedEvent {
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct AuthorizeRealtimeInput {
    socket_id: String,
    channel_name: String,
}
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct AttachSigningKitInput {
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct CreateAppleProfileInput {
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct CreateAppleCertificateInput {
    confirmed: bool,
}
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct CreateAppleCertificateResult {
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct DownloadAppleProfileResult {
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct CreateAppleProfileResult {
    profile: apple_api::AppleProvisioningProfileSummary,
    certificate: apple_api::AppleCertificateSummary,
    saved_path: String,
    kit: SigningKitSummary,
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct StoredMacGuestAccess {
    username: String,
}
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct MacGuestAccessInput {
    username: String,
}
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct AuthorizeMacGuestKeyInput {
    username: String,
    password: String,
}
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct ActivateMacXcodeInput {
    #[serde(default)]
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct ImportMacXcodeInput {
    path: String,
}
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct StoredSigningProvisioning {
    container_id: String,
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct AttachUsbDeviceInput {
    bus: u8,
    port: String,
}
...
#[ts(export)]
#[serde(rename_all = "camelCase")]
pub struct PairGuestDeviceInput {
    udid: String,
}
