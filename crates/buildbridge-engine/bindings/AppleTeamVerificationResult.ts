...
export type AppleTeamVerificationResult = {
    keyId: string;
    ...
    profiles: Array<AppleProvisioningProfileSummary>;
    certificatesAccessible: boolean;
    certificatesIssue: string | null;
    certificates: Array<AppleCertificateSummary>;
    devicesAccessible: boolean;
    devicesIssue: string | null;
    devices: Array<AppleDeviceSummary>;
